...
export class MovingPage implements OnInit {
  ...
  recentMovingSong: string = ''; // path of the recently played moving song
  recentMovingTitle: string = ''; // movie of the recently played moving song
  recentMovingArtist: string = ''; // artist of the recently played moving song
  ...
  // Array of moving songs containing song details:
  ...
  // Array for moving playlist songs:
  customSongs: { title: string, artist: string, songUrl: string }[] = [];

  /**
   * Constructor for MovingPage.
